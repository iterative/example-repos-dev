...
def main():
    ...
    training_images = mnist_images_idx_to_array("data/fashion-mnist/raw/train-images-idx3-ubyte.gz")
    # print(f"Read training data: {training_images}")
    training_labels = mnist_labels_idx_to_array("data/fashion-mnist/raw/train-labels-idx1-ubyte.gz")
    # print(f"Read training labels: {training_labels}")
    testing_images = mnist_images_idx_to_array("data/fashion-mnist/raw/t10k-images-idx3-ubyte.gz")
    # print(f"Read testing data: {testing_images}")
    testing_labels = mnist_labels_idx_to_array("data/fashion-mnist/raw/t10k-labels-idx1-ubyte.gz")
    ...
    np.savez("data/fashion-mnist/prepared/mnist-train.npz", images=training_images, labels=training_labels)
    np.savez("data/fashion-mnist/prepared/mnist-test.npz", images=testing_images, labels=testing_labels)
