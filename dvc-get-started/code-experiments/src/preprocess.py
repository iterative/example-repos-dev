...
def main():
    ...
    training_images, training_labels = load_npz_data("data/fashion-mnist/prepared/mnist-train.npz")
    testing_images, testing_labels = load_npz_data("data/fashion-mnist/prepared/mnist-test.npz")
    ...
    np.savez("data/fashion-mnist/preprocessed/mnist-train.npz", images=training_images, labels=training_labels)
    np.savez("data/fashion-mnist/preprocessed/mnist-test.npz", images=testing_images, labels=testing_labels)
